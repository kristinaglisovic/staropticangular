...
namespace Blog.DataAccess.Migrations
{
    ...
    [Migration("20221222232858_translations")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Blog.Domain.Entities.CategoryTranslation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("DesciptionEng")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Blog.Domain.Entities.PostTranslation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("Heading1Eng")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("Heading2Eng")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<string>("Text1Eng")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("Text2Eng")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("DescriptionEng");

                    b.HasIndex("Heading1Eng");

                    b.HasIndex("Heading2Eng");
            ...
            modelBuilder.Entity("Blog.Domain.Entities.TagTranslation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Blog.Domain.Entities.CategoryTranslation", b =>
                {
                    b.HasOne("Blog.Domain.Entities.Category", "Category")
                        .WithOne("CategoryTranslation")
                        .HasForeignKey("Blog.Domain.Entities.CategoryTranslation", "CategoryId")
            ...
            modelBuilder.Entity("Blog.Domain.Entities.PostTranslation", b =>
                {
                    b.HasOne("Blog.Domain.Entities.Post", "Post")
                        .WithOne("PostTranslation")
                        .HasForeignKey("Blog.Domain.Entities.PostTranslation", "PostId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Blog.Domain.Entities.TagTranslation", b =>
                {
                    b.HasOne("Blog.Domain.Entities.Tag", "Tag")
                        .WithOne("TagTranslation")
                        .HasForeignKey("Blog.Domain.Entities.TagTranslation", "TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
